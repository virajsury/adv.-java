...
<body style="width:100vw;">
    ...
    <div style="margin-left: 900px;margin-top: 200px; font-family: Sofia;  style=color: black; text-decoration: none;font-size: 30px;">Update Diary</div>
        ...
        <div style="margin-top:250px;"></div>
            ...
            <spr:form action="dairy_update.htm" method="post" commandName="dairy">
		...
		<div style="margin-left: 775px;margin-top: 20px; font-family: Sofia;  style=color:black;text-decoration: none;font-size: 20px;">Dairy: 
		
			<div style="margin-top: 10px;">
			<spr:textarea rows = "5" cols = "30" path="dairyData"/></div>
			</div> 
			
   
	<div style="margin-left: 870px;margin-top: 70px;font-family: Sofia;font-size: 20px;">
        
        <input type="submit" value="Back" formaction="home.jsp" style="color: black;text-decoration: none;"/>
        
        <input type="submit" value="Update" style="margin-left: 20px;" /></div>
</spr:form>
</div>
