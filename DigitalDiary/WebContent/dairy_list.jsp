...
<body style="width:100vw;">
    <div>
		...
		<thead>
              ...
              <tbody>
               <% 
		List<Dairy> dlist = (List<Dairy>)request.getAttribute("dairyList");
		for(Dairy dai : dlist){
		%>
                <tr style="text-align: center">
                  <td><%=dai.getTitle()%></td>
                  <td><%=dai.getContentDate()%></td>
                
                  <%-- <td><%=dai.getDairyData()%></td> --%>
				<td>
				<a href="dairy_update_form.htm?dairyId=<%=dai.getDairyId()%>">Update</a>
			</td>                 
                  <td><a href="dairy_delete.htm?dairyId=<%=dai.getDairyId()%>">Delete</a>
                				</td>
